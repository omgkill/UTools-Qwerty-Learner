          ...
          >
            <div className=" w-full ">
              ...
              <div className="mx-4 mt-6 flex rounded-xl bg-white px-4 py-3 opacity-50 shadow-xl">
                <DataBox data={state.statsData.timerData.time + ''} description="用时" />
                <DataBox data={state.statsData.timerData.accuracy + '%'} description="正确率" />
                <DataBox data={state.statsData.timerData.wpm + ''} description="WPM" />
              </div>
              <div className="ml-5 mt-4 self-start text-base text-gray-800">{currentDictInfo?.name}</div>
            </div>
            <div className="mb-3 ml-5 mt-auto">
              {/* <div className="text-xs">uTools Qwerty Learner</div> */}
