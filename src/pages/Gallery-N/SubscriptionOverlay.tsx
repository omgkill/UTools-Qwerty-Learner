...
interface SubscriptionOverlayProps {
  setGalleryState: (updater: (draft: { vipState: string }) => void) => void
}

export default function SubscriptionOverlay({ setGalleryState }: SubscriptionOverlayProps) {
  ...
  function handleClick(param: string) {
    ...
    window.utools?.openPayment({ goodsId: param === 'b' ? monthGoodsId : permanentGoodsId, attach: param }, () => {
