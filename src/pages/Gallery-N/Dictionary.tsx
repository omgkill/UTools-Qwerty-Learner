...
function DictionaryComponent({ wordBank, onClick }: Props) {
  return (
    <div className="flex h-40 w-80 items-center justify-center" role="button" onClick={onClick} title="选择词库">
      ...
      <div className="flex h-full w-7/12 flex-col items-start justify-start px-6 pt-2">
        <h1 className="mb-5 text-2xl font-normal">{wordBank.name}</h1>
        <p className="mb-6 text-lg text-gray-600">{wordBank.length}</p>
